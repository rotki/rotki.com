...
<template>
  <div class="grid grid-cols-1 gap-8 lg:grid-cols-[1.5fr_1fr] lg:gap-12 lg:items-start">
    <!-- Payment Information - First on mobile, Right on desktop -->
    <aside class="w-full lg:sticky lg:top-8 lg:self-start lg:order-2">
      <PaymentInfoCard
        v-if="paymentInfo"
    ...
    <div class="flex flex-col min-w-0 lg:order-1">
