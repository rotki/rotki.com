import type { PremiumTierInfoDescription, PremiumTiersInfo } from '#shared/types/tiers';
...
function enrichPlan(
  ...
  const comparison = isFirstPlan || !previousPlan
    ? getFirstPlanComparison(freePlanFeatures)
    : getSubsequentPlanComparison(previousPlan, tiers);
