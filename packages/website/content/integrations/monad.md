...
features:
  ...
  - "Protocol decoders on Monad: Uniswap, Curve, KyberSwap, Morpho, WooFi, 0x, Circle CCTP, Across, and WMON wrapping."
setup:
...
faq:
  ...
  - q: "Which protocols are decoded on Monad?"
    a: "rotki decodes Uniswap, Curve, KyberSwap, Morpho, WooFi, 0x, Circle CCTP, Across, and WMON wrapping on Monad, in addition to native and token transfers."
screenshots: []
ctaPlan: free
---
