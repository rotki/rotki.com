...
setup:
  ...
  - "Optional: in Settings → RPC, set your preferred Bitcoin mempool / Electrum endpoint."
  - "rotki will derive addresses, fetch balances, and pull transaction history."
faq:
  - q: "Where do my xpubs and addresses go?"
    a: "Only to the Bitcoin endpoint you configure (default public mempool, or your own Electrum/Bitcoin Core node). rotki does not proxy through its own servers."
  ...
  - q: "Can I run rotki against my own Bitcoin node?"
    a: "Yes. Point rotki at your own Electrum or Bitcoin Core REST endpoint in Settings → RPC for maximum privacy."
