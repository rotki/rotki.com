...
faq:
  ...
  - q: "Where is my Bitpanda API key sent?"
    a: "rotki is a local application: your Bitpanda API key is stored on your computer and used to sign each request, which goes directly from your machine to Bitpanda's API. No rotki-operated server ever sees the key or the request."
screenshots: []
ctaPlan: free
